          ...
          <div className="flex flex-col items-center justify-start ml-0.5 md:ml-[0] md:px-5 w-[13%] md:w-full">
            <div className="flex flex-row gap-2.5 items-center justify-center w-auto">
              <Img
                ...
                src="images/img_group1171275830_19.svg"
                alt="group1171275830"
              />
              <Text
        ...
        <div className="md:h-[824px] h-[913px] md:px-5 relative w-full">
          <div className="absolute bottom-[0] flex flex-col gap-[18px] inset-x-[0] justify-start mx-auto w-full">
            <div className="h-[701px] ml-6 md:ml-[0] relative w-[69%] md:w-full">
              ...
              <div className="absolute md:h-[484px] h-[494px] inset-x-[0] mx-auto top-[12%] w-[69%] md:w-full">
                <div className="absolute bg-white-A700 border border-light_blue-A700 border-solid flex flex-col h-max inset-[0] items-center justify-center m-auto pb-7 rounded-[16px] w-[99%]">
                  <div className="bg-light_blue-A700 flex flex-col items-center justify-end p-[7px] rounded-tl-[16px] rounded-tr-[16px] w-full">
                    ...
                    >
                      Video Live Screenshot-User Photo
                    </Text>
                  </div>
                  <div className="flex flex-col h-[298px] items-center justify-start mt-[22px] w-[298px]">
                    <Img
                      className="h-[298px] md:h-auto rounded-[50%] w-[298px]"
                      src="images/img_womanwithheadsetvideocall_298x298.png"
                      alt="womanwithheadse"
                    />
                  </div>
                  <div className="flex flex-row gap-[19px] items-center justify-center mt-7 w-[51%] md:w-full">
