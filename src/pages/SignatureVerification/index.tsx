          ...
          <div className="flex flex-col items-center justify-start ml-0.5 md:ml-[0] md:px-5 w-[13%] md:w-full">
            <div className="flex flex-row gap-2.5 items-center justify-center w-auto">
              <Img
                ...
                src="images/img_group1171275830_21.svg"
                alt="group1171275830"
              />
              <Text
          ...
          <div className="absolute bottom-[0] flex flex-col gap-[18px] inset-x-[0] justify-start mx-auto w-full">
            <div className="h-[701px] ml-6 md:ml-[0] relative w-[69%] md:w-full">
              <div className="h-[701px] m-auto w-full">
                ...
                <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[13%] w-[69%]">
                  <div className="bg-white-A700 border border-light_blue-A700 border-solid flex flex-col items-center justify-start pb-8 rounded-[16px] w-full">
                    ...
                    <Img
                      className="h-[205px] md:h-auto mt-[31px] object-cover w-4/5"
                      src="images/img_image17.png"
                      alt="imageSeventeen"
                    />
                    <div className="flex flex-row gap-[19px] items-center justify-center mt-[62px] w-[51%] md:w-full">
              ...
              <div className="absolute bg-light_blue-A700 h-[30px] outline outline-[1px] outline-white-A700 right-[15%] rounded-[50%] top-[12%] w-[30px]"></div>
            </div>
