          ...
          <div className="flex flex-col items-center justify-start ml-0.5 md:ml-[0] md:px-5 w-[13%] md:w-full">
            <div className="flex flex-row gap-2.5 items-center justify-center w-auto">
              <Img
                ...
                src="images/img_group1171275830_18.svg"
                alt="group1171275830"
              />
              <Text
        ...
        <div className="md:h-[824px] h-[913px] md:px-5 relative w-full">
          <div className="absolute bottom-[0] flex flex-col gap-[18px] inset-x-[0] justify-start mx-auto w-full">
            <div className="h-[701px] ml-6 md:ml-[0] relative w-[69%] md:w-full">
              <Img
                className="absolute h-[701px] inset-[0] justify-center m-auto object-cover w-full"
                src="images/img_maskgroup.png"
                alt="maskgroup"
              />
              <div
                className="absolute bg-cover bg-no-repeat flex flex-col h-[51px] items-center justify-start p-3.5 right-[2%] top-[2%] w-[51px]"
              ...
              <div className="absolute md:h-10 h-11 left-[1%] top-[2%] w-[14%]">
              ...
              <div className="absolute flex flex-col h-[399px] sm:h-auto items-center justify-start right-[28%] top-[6%] w-[399px]">
                <Img
                  className="h-[399px] md:h-auto rounded-[50%] w-[399px]"
                  src="images/img_womanwithheadsetvideocall_399x399.png"
                  alt="womanwithheadse"
                />
              </div>
              <div className="absolute flex flex-col h-[425px] sm:h-auto items-center justify-end outline outline-[7px] outline-green-A700 p-1.5 right-[26%] rounded-[212px] top-[4%] w-[425px]">
                <Line className="bg-light_blue-A700 h-[239px] mt-[174px] w-px" />
              </div>
              <div className="absolute bottom-[2%] flex md:flex-col flex-row md:gap-10 inset-x-[0] items-end justify-between mx-auto w-[97%]">
                ...
                <div className="flex flex-col items-center justify-start mb-0.5 w-[44%] md:w-full">
              ...
              <Img
                className="absolute h-[174px] right-[19%] top-[20%] w-[50px]"
          ...
          <div className="absolute flex md:flex-col flex-row gap-[43px] items-center justify-between left-[3%] top-[2%] w-auto">
            <div className="md:h-[27px] h-[49px] relative w-[58%] md:w-full">
              ...
              <div className="absolute h-[49px] inset-y-[0] my-auto right-[0] w-[92%] sm:w-full">
                ...
                <Text
                  className="bg-light_blue-A700 h-[27px] justify-center mb-[-0.64px] ml-auto mr-[186px] px-[9px] rounded-[14px] text-base text-white-A700 uppercase w-7 z-[1]"
