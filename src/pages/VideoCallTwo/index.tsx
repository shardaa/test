...
const VideoCallTwoPage: React.FC = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto w-full">
          ...
          <div className="flex flex-col items-center justify-start ml-0.5 md:ml-[0] md:px-5 w-[13%] md:w-full">
            <div className="flex flex-row gap-2.5 items-center justify-center w-auto">
              <Img
                ...
                src="images/img_group1171275830_8.svg"
                alt="group1171275830"
              />
              <Text
        ...
        <div className="md:h-[824px] h-[849px] md:px-5 relative w-full">
          <div className="absolute flex flex-col gap-6 h-max inset-[0] justify-center m-auto w-full">
            <div className="flex flex-col items-center justify-start ml-6 md:ml-[0] w-[69%] md:w-full">
              <div className="flex flex-col items-center justify-start w-full">
                <div className="h-[695px] relative w-full">
                  <Img
                    className="h-[695px] m-auto object-cover rounded-[15px] w-full"
                    src="images/img_womanwithheadsetvideocall.png"
                    alt="womanwithheadse"
                  />
                  <div className="absolute flex flex-col md:gap-10 gap-[393px] h-max inset-[0] items-center justify-center m-auto w-[98%]">
                              ...
                              <div className="h-[221px] relative w-full">
                                ...
                                <div className="absolute h-[221px] inset-[0] justify-center m-auto w-full">
                                  <Img
                                    ...
                                    alt="imageFifteen"
                                  />
                                  <div className="absolute bg-gradient  bottom-[0] flex flex-row inset-x-[0] items-start justify-between mx-auto p-[11px] w-full">
                                    <div className="flex flex-col items-start justify-start mt-[52px] w-auto">
                                      <Button
...
export default VideoCallTwoPage;
