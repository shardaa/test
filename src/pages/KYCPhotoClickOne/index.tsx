...
const KYCPhotoClickOnePage: React.FC = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto w-full">
          ...
          <div className="flex flex-col items-center justify-start ml-0.5 md:ml-[0] md:px-5 w-[13%] md:w-full">
            <div className="flex flex-row gap-2.5 items-center justify-center w-auto">
              <Img
                ...
                src="images/img_group1171275830_9.svg"
                alt="group1171275830"
              />
              <Text
        ...
        <div className="md:h-[1032px] sm:h-[824px] h-[849px] md:px-5 relative w-full">
          <div className="absolute flex flex-col gap-6 h-max inset-[0] justify-center m-auto w-full">
            <div className="flex flex-col items-center justify-start ml-6 md:ml-[0] w-[69%] md:w-full">
              <div className="flex flex-col items-center justify-start w-full">
                <div className="h-[695px] md:h-[903px] relative w-full">
                  <Img
                    className="h-[695px] m-auto object-cover rounded-[15px] w-full"
                        ...
                        <div className="h-[405px] md:ml-[0] ml-[147px] md:mt-0 mt-1.5 relative w-[405px] sm:w-full">
                          <div className="flex flex-col sm:h-auto h-full items-center justify-start m-auto w-[381px]">
                            <Img
                              ...
                              src="images/img_womanwithheadsetvideocall_381x381.png"
                              alt="womanwithheadse_One"
                            />
                          </div>
                          <div className="absolute h-[405px] inset-[0] justify-center m-auto outline outline-[7px] outline-red-600 rounded-[202px] w-[405px]"></div>
                        </div>
                        <div
                                ...
                                <div className="h-[221px] relative w-full">
                                  ...
                                  <div className="absolute h-[221px] inset-[0] justify-center m-auto w-full">
                                    ...
                                    <div className="absolute bg-gradient  bottom-[0] flex flex-row inset-x-[0] items-end justify-between mx-auto p-2.5 w-full">
                                      <div className="flex flex-col items-start justify-start mt-[54px] w-auto">
                                        <Button
                                      ...
                                      <Button
                                        className="flex h-[39px] items-center justify-center mb-0.5 mr-0.5 mt-12 rounded-[19px] w-[39px]"
...
export default KYCPhotoClickOnePage;
