...
const VideoKYCFourPage: React.FC = () => {
      ...
      label: (
        <div className="flex flex-row gap-3.5 items-center justify-start w-auto">
          <Img
            ...
            alt="group"
          />
          <Text className="text-white-A700 w-auto">Appointment History</Text>
        </div>
      ),
    },
    {
      label: (
        <div className="flex flex-row gap-3.5 items-center justify-start w-auto">
          <Img
            ...
            alt="group_One"
          />
          <Text className="text-white-A700 w-auto">Option 3</Text>
        </div>
      ),
    },
    {
      label: (
        <div className="flex flex-row gap-3.5 items-center justify-center w-auto">
          <Img className="h-6 w-6" src="images/img_group.svg" alt="group_Two" />
          <Text className="text-light_blue-A700 w-auto">Rejection List</Text>
        </div>
      ),
    },
    {
      label: (
        <div className="flex flex-row gap-3.5 items-center justify-start w-auto">
          <Img
            ...
            alt="group_Three"
          />
          <Text className="text-white-A700_87 w-auto">Option 5</Text>
        </div>
      ),
    },
    {
      label: (
        <div className="flex flex-row gap-3.5 items-center justify-start w-auto">
          <Img
            ...
            alt="group_Four"
          />
          <Text className="text-white-A700_87 w-auto">Calendar</Text>
        </div>
      ),
    },
    {
      label: (
        <div className="flex flex-row gap-3.5 items-center justify-start w-auto">
          <Img
            ...
            alt="group_Five"
          />
          <Text className="text-white-A700_87 w-auto">Option 7</Text>
        </div>
      ),
    },
    {
          ...
          >
            <div className="flex flex-row gap-2.5 items-center justify-center mb-[878px] ml-7 mr-[53px] mt-[27px] w-auto">
              <Img
                ...
                src="images/img_group1171275830_24.svg"
                alt="group1171275830"
              />
              <Text
            ...
            <Menu
              ...
              className="h-[402px] md:h-[936px] mb-[409px] mt-[125px] sm:pr-5 pr-7 pt-[151px] relative w-[90%]"
            >
              <div className="absolute bg-white-A700 h-12 inset-x-[0] mx-auto rounded-[12px] top-[38%] w-full"></div>
...
export default VideoKYCFourPage;
