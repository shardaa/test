...
const KYCPhotoClickTwoPage: React.FC = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto w-full">
          ...
          <div className="flex flex-col items-center justify-start ml-0.5 md:ml-[0] md:px-5 w-[13%] md:w-full">
            <div className="flex flex-row gap-2.5 items-center justify-center w-auto">
              <Img
                ...
                src="images/img_group1171275830_11.svg"
                alt="group1171275830"
              />
              <Text
        ...
        <div className="sm:h-[823px] h-[849px] md:h-[952px] md:px-5 relative w-full">
          <div className="absolute flex flex-col gap-6 h-max inset-[0] justify-center m-auto w-full">
            <div className="flex flex-col items-center justify-start ml-6 md:ml-[0] w-[69%] md:w-full">
              <div className="flex flex-col items-center justify-start w-full">
                <div className="sm:h-[694px] h-[695px] md:h-[823px] relative w-full">
                  <Img
                    ...
                    alt="womanwithheadse"
                  />
                  <div className="absolute bg-blue_gray-100_99 flex flex-col h-max inset-[0] items-center justify-center m-auto p-[13px] rounded-[16px] w-full">
                    <div className="flex flex-col md:gap-10 gap-[77px] items-center justify-start w-full">
                      <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                        ...
                        <div className="h-[318px] md:ml-[0] ml-[68px] md:mt-0 mt-[49px] relative w-[59%] md:w-full">
                          <Img
                            className="h-[318px] m-auto object-cover w-full"
                            src="images/img_womanwithheadsetvideocall_318x564.png"
                            alt="womanwithheadse_One"
                          />
                          <div className="absolute border-[7px] border-green-A700 border-solid flex flex-col h-full inset-[0] items-center justify-center m-auto p-[43px] md:px-10 sm:px-5 w-full">
                            <Img
                              className="h-[231px] md:h-auto object-cover w-[81%]"
                        ...
                        <div
                          className="bg-cover bg-no-repeat flex flex-col h-[51px] items-center justify-start md:ml-[0] ml-[145px] p-3.5 w-[51px]"
                          style={{
                      ...
                      <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between w-full">
                        <div className="flex flex-col h-[50px] md:h-auto items-start justify-start md:mt-0 mt-[171px] w-[199px]">
                          <Button
...
export default KYCPhotoClickTwoPage;
