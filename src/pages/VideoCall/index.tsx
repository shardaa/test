    ...
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto w-full">
          ...
          <div className="flex flex-col items-center justify-start ml-0.5 md:ml-[0] md:px-5 w-[13%] md:w-full">
            <div className="flex flex-row gap-2.5 items-center justify-center w-auto">
              <Img
                ...
                src="images/img_group1171275830_14.svg"
                alt="group1171275830"
              />
              <Text
        ...
        <div className="md:h-[824px] h-[913px] md:px-5 relative w-full">
          ...
          <div className="absolute flex md:flex-col flex-row gap-[43px] items-center justify-between left-[2%] top-[2%] w-auto">
            <div className="md:h-[27px] h-[49px] relative w-[59%] md:w-full">
              <Text
                className="absolute bottom-[0] left-[0] text-center text-light_blue-A700_87 text-sm"
                size="txtPoppinsMedium14LightblueA70087"
              >
                Verify Details
              </Text>
              <div className="absolute h-[49px] inset-y-[0] my-auto right-[0] w-[90%] sm:w-full">
                <Text
              ...
              <Button
                className="!text-white-A700_87 absolute cursor-pointer font-medium h-[27px] leading-[normal] left-[5%] rounded-[14px] text-center text-sm top-[0] uppercase w-7"
                color="light_blue_A700_87"
                size="xs"
                variant="fill"
              >
            ...
            <div className="flex flex-row gap-[9px] items-center justify-between w-[36%] md:w-full">
              <List
